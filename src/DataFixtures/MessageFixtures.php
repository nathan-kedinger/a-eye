...
class MessageFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        for ($i = 1; $i <= 100; $i++) {
            ...
            $message->setUserMessage($this->getReference(UserFixtures::USER_REFERENCE . rand(1, 11), User::class,));
            ...
            $message->setConversation($this->getReference('conversation_' . rand(1, 10), Conversation::class));
